...
class CustomerProductListingGetSchema(Schema):
    ...
    collections = fields.List(fields.Int(), data_key="collections")
    categories = fields.List(fields.Int(), data_key="categories")
    occasions = fields.List(fields.Int(), data_key="occasions")
    tags = fields.List(fields.Int(), data_key="tags")
